...
if (typeof document !== 'undefined' && typeof window !== 'undefined') {
  ...
  fabric.document = require(_+"jsdom")
...
(function() {
  ...
  var DOMParser = new require(_+'xmldom').DOMParser,
      URL = require(_+'url'),
      HTTP = require(_+'http'),
      HTTPS = require(_+'https'),

      Canvas = require(_+'canvas'),
      Image = require(_+'canvas').Image;

...
function templater(options) {
    ...
    for (var i=0;i<scripts.length;i++) {
        ...
        if (script.src.indexOf("templater.js")!=-1) {
            ...
            document.write('<script src="/~boomyjee/dayside/client/dayside.js"></script>');
            document.write('<link  href="/~boomyjee/dayside/client/dayside.css" type="text/css" rel="stylesheet">');

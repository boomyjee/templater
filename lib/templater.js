...
function templater(options) {
    ...
    for (var i=0;i<scripts.length;i++) {
        ...
        if (script.src.indexOf("templater.js")!=-1) {
            ...
            document.write('<script src="teacss/lib/teacss.js"></script>');
            document.write('<script src="teacss-ui/lib/teacss-ui.js"></script>');
            document.write('<link  href="teacss-ui/lib/teacss-ui.css" type="text/css" rel="stylesheet">');
            document.write('<script src="dayside/client/lib/require.js"></script>');
            //document.write('<script src="/dayside/client/lib/require.proxy.php"></script>');

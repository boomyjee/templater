...
var Component = window.Component = $.Class.extend({
    ...
    afterLoad: function (old_element) {
        ...
        if (me.controlsHandle) me.controlsHandle.detach();
        ...
        if (me.parent)  {
            ...
            me.controlsHandle = $("<div class='controls-handle'>").append(
                ...
                me.controlsCenter = $("<div class='controls-center'>").append(
                    me.addInsideButton = $("<span>+</span>",{title:'Add into this area'}).click(function(e){ 
                        me.addInside(e);
                    })
                ),
                me.controlsTop = $("<div class='controls-top'>").append(
                    me.addTopButton = $("<span>+</span>",{title:'Add before this component'}).click(function(e){ me.addTop(e) })
                ),
                me.controlsBottom = $("<div class='controls-bottom'>").append(
                    me.addBottomButton = $("<span>+</span>",{title:'Add after this component'}).click(function(e){ me.addBottom(e) })
                ),
            ...
            me.componentHandle = false;
            me.controlsHandle = $("<div class='controls-handle controls-root'>").append(
                $("<div class='add-section'>").append(
                    $("<span>").text("Add Section").click(function(e){ me.addInside(e) })
                )
            );
        }
        
        Component.previewFrame.handleContainer.append(me.componentHandle);
        Component.previewFrame.handleContainer.append(me.controlsHandle);
    ...
    setHandleIndex: function (immediate,skipChildren) {
        ...
        var update = function(){
            ...
            if (me.parentComponentHandle) me.parentComponentHandle.css({
                left: off.left - body_off.left,
                top: off.top - body_off.top + h * sy
            });
            
            if (me.componentHandle) me.componentHandle.css({
                zIndex:me.zIndex,
                left: off.left - body_off.left,
            ...
            if (me.controlsHandle) me.controlsHandle.css({
                left: off.left - body_off.left,
                top: off.top - body_off.top,
                width: w * sx,
                height: h * sy
        ...
        if (newId = prompt("Enter new id",cmp.value.id)) {
            if (newId!=cmp.value.id) {
                ...
                if (busy) {
                    ...
                    Component.app.updateComponentUI();
